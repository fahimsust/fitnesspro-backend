...
class SetZoomTemplate
{
    ...
    public function handle(
        ...
        ProductSettings::whereIn('product_id',$request->ids)->update(['product_zoom_template'=>$request->template_id]);
        return CreateActivity::run(
            $request->ids,
            [
                'product_zoom_template' => $request->template_id,
            ],
