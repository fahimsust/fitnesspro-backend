...
class LayoutSection extends Model
{
    ...
    //  {
//      return $this->hasMany(CategoriesSettingsSitesModulevalue::class, 'section_id');
    //  }
//
    //  public function categories_settings_templates_modulevalues()
    //  {
//      return $this->hasMany(CategoriesSettingsTemplatesModulevalue::class, 'section_id');
    //  }
//
    //  public function pages_settings_sites_modulevalues()
    //  {
//      return $this->hasMany(PagesSettingsSitesModulevalue::class, 'section_id');
    //  }
//
    //  public function pages_settings_templates_modulevalues()
    //  {
//      return $this->hasMany(PagesSettingsTemplatesModulevalue::class, 'section_id');
    //  }
//
    //  public function products_settings_sites_modulevalues()
    //  {
//      return $this->hasMany(ProductsSettingsSitesModulevalue::class, 'section_id');
    //  }
//
    //  public function products_settings_templates_modulevalues()
    //  {
//      return $this->hasMany(ProductsSettingsTemplatesModulevalue::class, 'section_id');
    //  }
//
    //  public function sites_settings_modulevalues()
    //  {
//      return $this->hasMany(SitesSettingsModulevalue::class, 'section_id');
    //  }
}
