...
class CapturePaypalPayment implements ShouldQueue
{
        ...
        try {
            ...
            UpdateOrderTransactionFromDto::now(
                ...
                dto: ConvertOrderToTransactionDto::now(
                    ...
                    overrideStatus: OrderTransactionStatuses::Captured
                )
            );

            LoadOrderById::now($this->transaction->order_id)
                ->activity('Payment captured with Paypal.');
