...
use App\Api\Accounts\Middleware\AccountApiVerification;
use Illuminate\Foundation\Http\Kernel as HttpKernel;
use Support\Middleware\StripHtmlTagsForApi;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'account.api.verify' => AccountApiVerification::class,
        'strip.html.api' => StripHtmlTagsForApi::class,
    ];
}
