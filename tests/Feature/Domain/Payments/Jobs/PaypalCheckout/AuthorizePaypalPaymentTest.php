...
class AuthorizePaypalPaymentTest extends \Tests\TestCase
{
...
JSON
        ...
        AuthorizePaypalPayment::dispatch(
            $transaction->id
        );

        $this->assertEquals(OrderTransactionStatuses::Authorized, $transaction->fresh()->status);
