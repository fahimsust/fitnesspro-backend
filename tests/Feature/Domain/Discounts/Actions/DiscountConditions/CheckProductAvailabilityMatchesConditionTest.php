...
class CheckProductAvailabilityMatchesConditionTest extends TestCase
{
    public Cart $cart;
    ...
    )
    {
        ...
        $this->discountCondition = DiscountCondition::factory()->create(
            [
                ...
                'condition_type_id' => DiscountConditionTypes::PRODUCT_AVAILABILITY->value
            ]
        );
        $productAvailability = ProductAvailability::factory()->create();
        ConditionProductAvailability::factory()->create([
