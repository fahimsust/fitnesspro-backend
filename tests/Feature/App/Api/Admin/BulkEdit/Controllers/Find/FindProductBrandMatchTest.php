...
class FindProductBrandMatchTest extends ControllerTestCase
{
    ...
    /** @test */
    public function can_search_product_by_product_brand()
    {
        ...
        $this->postJson(
            ...
            [
                'search_option' => SearchOptions::BRAND_IS->value,
                'brand_id' => $brand->id,
            ]
        )
            ->assertOk()
