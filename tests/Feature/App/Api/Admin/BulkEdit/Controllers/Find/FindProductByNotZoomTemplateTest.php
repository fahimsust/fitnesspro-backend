...
class FindProductByNotZoomTemplateTest extends ControllerTestCase
{
    ...
    /** @test */
    public function can_search_product_by_product_zoom_template_is_not()
    {
        ...
        $this->postJson(
            ...
            [
                'search_option' => SearchOptions::PRODUCT_ZOOM_TEMPLATE_IS_NOT->value,
