...
class FindProductCombinedStockNotBetweenTest extends ControllerTestCase
{
    ...
    public function can_search_product_by_product_stock()
    {
        ...
        $this->postJson(
            ...
            [
                'search_option' => SearchOptions::COMBINED_STOCK_QUANTITY_IS_NOT_BETWEEN->value,
                'min' => 0,
                'max' => 100,
            ]
        )
    ...
    /** @test */
    public function can_validate_request_and_return_stock()
    {
        $this->postJson(
            route('admin.bulk-edit-find.store'),
            [
