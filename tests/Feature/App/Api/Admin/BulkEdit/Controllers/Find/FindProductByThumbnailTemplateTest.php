...
class FindProductByThumbnailTemplateTest extends ControllerTestCase
{
    ...
    /** @test */
    public function can_search_product_by_product_thumbnail_template()
    {
        ...
        $this->postJson(
            ...
            [
                'search_option' => SearchOptions::PRODUCT_THUMBNAIL_TEMPLATE_IS->value,
