...
class CategorySettingsTemplateModuleControllerTest extends ControllerTestCase
{
    ...
    {
        $result = $this->getJson(route('admin.category-settings-template-module.sections',['module_template_id'=>$this->moduleTemplate] ))
            ->assertOk()
            ->assertJsonStructure([
                '*' => [
                    'sections',
