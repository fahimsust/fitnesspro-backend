...
class DetailDisplayTemplateControllerTest extends ControllerTestCase
{
    protected function setUp(): void
    {
        parent::setUp();
        $this->createAndAuthAdminUser();
        $displayTemplateType = DisplayTemplateType::factory()->create(['id'=>config('display_templates.product_detail')]);
    ...
    {
        $this->getJson(route('admin.display-template-detail.index'))
            ->assertOk()
            ->assertJsonStructure([
                '*' => [
                    'id',
