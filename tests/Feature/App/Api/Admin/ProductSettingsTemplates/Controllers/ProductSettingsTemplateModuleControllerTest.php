...
class ProductSettingsTemplateModuleControllerTest extends ControllerTestCase
{
    ...
    {
        $result = $this->getJson(route('admin.product-settings-template-module.sections',['module_template_id'=>$this->moduleTemplate] ))
            ->assertOk()
            ->assertJsonStructure([
                '*' => [
                    'sections',
